<div class="page-section">
      ...
      <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
        ...
        <div class="item">
          <div class="card-doctor">
            <div class="header">
              <img style="height: 300px !important" src="doctor_image/<?php echo e($doctors->image); ?>" height="300px" alt="">
              <div class="meta">
  ...
  </div><?php /**PATH C:\xampp\htdocs\Laravel Final\resources\views/user/doctor.blade.php ENDPATH**/ ?>