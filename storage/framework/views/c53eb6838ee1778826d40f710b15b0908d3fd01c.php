  ...
  <div align="center" style="padding: 70px;">
      <table>
          ...
          <tr style="background-color:black ;" align="center">
              <td style="color: white; padding: 10px;"><?php echo e($appoints->doctor); ?></td>
              <td style="color: white; padding: 10px;"><?php echo e($appoints->date); ?></td>
              <td style="color: white; padding: 10px;"><?php echo e($appoints->message); ?></td>
              <td style="color: white; padding: 10px;"><?php echo e($appoints->status); ?></td>
              <td><a class="btn btn-danger" onclick="return confirm('you sure want to delete this')" href="<?php echo e(url('cancel_appoint',$appoints->id)); ?>">Cancel</a></td>
          </tr>
...
</html><?php /**PATH C:\xampp\htdocs\Laravel Final\resources\views/user/my_appointment.blade.php ENDPATH**/ ?>